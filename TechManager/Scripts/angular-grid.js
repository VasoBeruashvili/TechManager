...
(function (awk) {
    ...
    (function (grid) {
        ...
        var template = '<div>' + '<div>' + '<select class="ag-filter-select" id="filterType">' + '<option value="1">[შეიცავს]</option>' + '<option value="2">[უდრის]</option>' + '<option value="3">[იწყება]</option>' + '<option value="4">[ბოლოვდება]</option>' + '</select>' + '</div>' + '<div>' + '<input class="ag-filter-filter" id="filterText" type="text" placeholder="[ფილტრი...]"/>' + '</div>' + '<div class="ag-filter-apply-panel" id="applyPanel">' + '<button type="button" id="applyButton">Apply Filter</button>' + '</div>' + '</div>';
        var CONTAINS = 1;
        var EQUALS = 2;
        var STARTS_WITH = 3;
        var ENDS_WITH = 4;
        var TextFilter = (function () {
            ...
            TextFilter.prototype.createTemplate = function () {
                return template.replace('[ფილტრი...]', this.localeTextFunc('filterOoo', 'ფილტრი...')).replace('[უდრის]', this.localeTextFunc('equals', 'უდრის')).replace('[შეიცავს]', this.localeTextFunc('contains', 'შეიცავს')).replace('[იწყება]', this.localeTextFunc('startsWith', 'იწყება')).replace('[ბოლოვდება]', this.localeTextFunc('endsWith', 'ბოლოვდება'));
            };
...
(function (awk) {
    ...
    (function (grid) {
        var utils = grid.Utils;
        var template = '<div>' + '<div>' + '<select class="ag-filter-select" id="filterType">' + '<option value="1">[უდრის]</option>' + '<option value="2">[ნაკლებია]</option>' + '<option value="3">[მეტია]</option>' + '</select>' + '</div>' + '<div>' + '<input class="ag-filter-filter" id="filterText" type="text" placeholder="[ფილტრი...]"/>' + '</div>' + '<div class="ag-filter-apply-panel" id="applyPanel">' + '<button type="button" id="applyButton">Apply Filter</button>' + '</div>' + '</div>';
        var EQUALS = 1;
        var LESS_THAN = 2;
        var GREATER_THAN = 3;
        var NumberFilter = (function () {
            ...
            NumberFilter.prototype.createTemplate = function () {
                return template.replace('[ფილტრი...]', this.localeTextFunc('filterOoo', 'ფილტრი...')).replace('[უდრის]', this.localeTextFunc('equals', 'უდრის')).replace('[ნაკლებია]', this.localeTextFunc('lessThan', 'ნაკლებია')).replace('[მეტია]', this.localeTextFunc('greaterThan', 'მეტია'));
            };
...
(function (awk) {
    ...
    (function (grid) {
        var _ = grid.Utils;
        var template = '<div>' + '<div class="ag-filter-header-container">' + '<input class="ag-filter-filter" type="text" placeholder="ძებნა..."/>' + '</div>' + '<div class="ag-filter-header-container">' + '<label>' + '<input id="selectAll" type="checkbox" class="ag-filter-checkbox"/>' + '(ყველას მონიშვნა)' + '</label>' + '</div>' + '<div class="ag-filter-list-viewport">' + '<div class="ag-filter-list-container">' + '<div id="itemForRepeat" class="ag-filter-item">' + '<label>' + '<input type="checkbox" class="ag-filter-checkbox" filter-checkbox="true"/>' + '<span class="ag-filter-value"></span>' + '</label>' + '</div>' + '</div>' + '</div>' + '<div class="ag-filter-apply-panel" id="applyPanel">' + '<button type="button" id="applyButton">Apply Filter</button>' + '</div>' + '</div>';
    ...
    (function (grid) {
        ...
        var SvgFactory = (function () {
            ...
            SvgFactory.prototype.createFilterSvg = function () {
                ...
                eFunnel.setAttribute("fill", "#919191");
            ...
            SvgFactory.prototype.createMenuSvg = function () {
                ...
                //["0", "5", "10"].forEach(function (y) {
                    ...
                    eLine.setAttribute("y", 0);
                    eLine.setAttribute("width", "5");
                    eLine.setAttribute("height", "5");

                    eLine.setAttribute("fill", "#919191");
                    eLine.setAttribute("style", "-webkit-transform: rotate(45deg);");
            ...
            HeaderRenderer.prototype.createHeaderCell = function (column, grouped, headerGroup) {
                ...
                if (showMenu) {
                    ...
                    eHeaderCell.onmouseenter = function () {
                        ...
                        eMenuButton.setAttribute("style", "border-left: 1px solid #919191; padding-left: 10px; margin-top: -1px; margin-right: -5px; padding-top: 5px;");
                    };
...
(function (awk) {
    ...
    (function (grid) {
        ...
        var loadingHtml = '<div class="ag-loading-panel">' + '<div class="ag-loading-wrapper">' + '<span class="ag-loading-center"><img src="../../Content/Resources/preloader.gif" /></span>' + '</div>' + '</div>';
        var utils = grid.Utils;
